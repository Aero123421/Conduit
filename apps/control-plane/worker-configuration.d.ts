/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe59747522b6779f85f2d9e857f0b5bf)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	EVENT_INGESTION: Queue;
	ASSETS: Fetcher;
	...
	BOARD_ROOMS: DurableObjectNamespace<import("./src/index").BoardRoom>;
	CONNECTOR_LIMITERS: DurableObjectNamespace<import("./src/index").ConnectorLimiter>;
	RETRY_SCHEDULER: DurableObjectNamespace<import("./src/index").RetryScheduler>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeviceRoom" | "BoardRoom" | "ConnectorLimiter" | "RetryScheduler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "OAUTH_ISSUER" | "WEBAUTHN_RP_ID" | "WEBAUTHN_RP_NAME" | "DCR_MODE" | "CLOUDFLARE_USAGE_PROFILE">> {}
}
